...
const DEFAULT_PRICING = {
  badge: 'Test Pricing',
  mainTitle: 'Simple Test',
  mainTitleHighlight: 'Pricing',
  mainDescription:
    'Choose a plan to test our services. Simple pricing structure for demonstration and testing purposes.',
  billingMonthly: 'Monthly',
  billingAnnual: 'Annual',
  billingAnnualBadge: 'Save 20%',
  plan1Name: 'Basic Test',
  plan1Description: 'Perfect for basic testing and demos',
  plan1Price: 'Free',
  plan1CTA: 'Start Testing',
  plan1CTAHref: '/test',
  plan2Name: 'Pro Test',
  plan2Description: 'Best for comprehensive testing needs',
  plan2Price: '$19',
  plan2Period: '/month',
  plan2Badge: 'Most Popular',
  plan2CTA: 'Start Free Trial',
  plan2CTAHref: '/trial',
  plan2Trial: '7-day free trial • No credit card required',
  plan3Name: 'Enterprise Test',
  plan3Description: 'For large-scale testing requirements',
  plan3Price: 'Custom',
  plan3Badge: 'Contact Us',
  plan3CTA: 'Contact Sales',
  plan3CTAHref: '/contact',
  bottomTitle: 'Need a custom test setup?',
  bottomDescription:
    'We can create custom test environments and configurations tailored to your specific testing requirements.',
