...
const DEFAULT_FOOTER = {
  logoText: 'TestFlow',
  companyDescription:
    'A simple test website showcasing modern web development with clean design and essential features. Perfect for testing and demonstration purposes.',
  contactEmail: 'hello@testflow.com',
  contactPhone: '+1 (555) 123-4567',
  contactAddress: '123 Test Street, Suite 100',
  newsletterTitle: 'Stay Updated',
  newsletterPlaceholder: 'Enter your email',
  newsletterDisclaimer:
    'Get updates on new features and improvements. No spam, unsubscribe anytime.',
  section1Title: 'Product',
  section2Title: 'Company',
  section3Title: 'Resources',
  section4Title: 'Legal',
  copyrightText: '© 2024 TestFlow. All rights reserved.',
  madeWithText: 'with care',
  socialText: 'Follow us:',
  social1Href: 'https://twitter.com/testflow',
  social2Href: 'https://facebook.com/testflow',
  social3Href: 'https://instagram.com/testflow',
  social4Href: 'https://linkedin.com/company/testflow',
  social5Href: 'https://github.com/testflow',
} as const;
